...
### Task 11: Commit something to "new"-branch and push to remote
- bla
...
### Task 12: Merge "new"-branch into main via a pull request
...
### Task 13: Delete the "new"-branch with the web-interface
