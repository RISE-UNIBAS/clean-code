The folder [`course/github`](https://github.com/RISE-UNIBAS/clean-code/tree/main/course/github) contains Markdown files on version control and documentation with GitHub:
