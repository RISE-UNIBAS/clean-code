...
- Read and maintain your code effectively
...
- Avoid technical debt in research projects
- Collaborate efficiently with version control
- Leverage AI tools for code improvement and documentation
...
**Materials**: [Git](../git/git.md) | [Documentation](../docs/docs.md) | [GitHub](../github/README.md)
...
- 09:00 Introduction and clean code in context
  ...
  - File encoding (UTF-8)
  - Connecting RStudio to GitHub ([Happy Git with R](https://happygitwithr.com/))
- 10:15 Break
...
**Materials**: [Clean Code in Context](../clean_code_in_context/clean_code_in_context.md)
...
**Materials**: [AI-Assisted Coding](../ai_tools/ai_coding.md)
