...
The two code chunks above do the same thing, but the second one avoids unnecessary clutter. In general, I recommend using loops or the apply()-family of functions to perform a task repeatedly.
